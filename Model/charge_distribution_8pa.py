...
Vp_guess = -0.3450820594713917      # Particle Potential (eV) (Initial Guess)
ni_guess = 1.9599555959927172e+16  # Ion Density [1/m3]
...
EN_guess = 720           # Reduced Electric Field [Td]
p = 8                           # Pressure [Pa]
...
bb_guess = 7.1E-15               # Amplitude of detachment cross section
        ...
        for Vpp in np.linspace(4, -15):
            for nee in np.linspace(1E12, 1E18):
                ...
                if np.absolute((Vp - Vpp)/Vp) > tol_iter:
                    ...
                    Te = np.multiply(0.66666666666666666666666, np.trapz(((E ** 1.5)*z1), E))
                    np.savetxt('EEPF_8Pa_np5e15.txt', np.column_stack([E,z1]), delimiter = ',')
