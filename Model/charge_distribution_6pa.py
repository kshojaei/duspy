...
Vp_guess = -0.28010867180809795      # Particle Potential (eV) (Initial Guess)
ni_guess = 1.5898655059026272e+16  # Ion Density [1/m3]
...
EN_guess = 730           # Reduced Electric Field [Td]
p = 6                           # Pressure [Pa]
...
bb_guess = 9.5E-15               # Amplitude of detachment cross section
        ...
        for Vpp in np.linspace(4, -15):
            for nee in np.linspace(1E12, 1E18):
                ...
                if np.absolute((Vp - Vpp)/Vp) > tol_iter:
                    ...
                    Te = np.multiply(0.66666666666666666666666, np.trapz(((E ** 1.5)*z1), E))
                    np.savetxt('EEPF_6Pa_np5e15.txt', np.column_stack([E,z1]), delimiter = ',')
