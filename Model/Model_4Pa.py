...
Vp_guess = -1.1307399858181215# Particle Potential (eV) (Initial Guess)
ni_guess = 1.3278719115840884e+16 # Ion Density [1/m3]
...
EN_guess = 1264.0           # Reduced Electric Field [Td]
p = 4                           # Pressure [Pa]
...
bb_guess = 1.620035E-13               # Amplitude of detachment cross section
        ...
        for Vpp in np.linspace(4, -15):
            for nee in np.linspace(1E12, 1E18):
                ...
                if np.absolute((Vp - Vpp)/Vp) > tol_iter:
                    ...
                    Te = np.multiply(0.66666666666666666666666, np.trapz(((E ** 1.5)*z1), E))
                    np.savetxt('EEPF_4Pa_dist_photo.txt', np.column_stack([E,z1]), delimiter = ',')
